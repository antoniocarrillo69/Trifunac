//////////////////////////////////////////////////////////////////////////////////////////////
// Ventana de graficación de caja en 3D                                                     //
...
/////////////////////////////////////////////////////////////
// Clase Ventana Caja 3D                                   //
/////////////////////////////////////////////////////////////

void Ventana_Caja_3D::Inicializa(void)
{
   Factor = 1.1;
   TETA = M_PI / 5.5;
   FI = M_PI / 2.0;
...
void Ventana_Caja_3D::Calcula_valores(void)
{
   ST = sinl(TETA);
   CT = cosl(TETA);
   SF = sinl(FI);
...
// Dibuja al ventana
void Ventana_Caja_3D::Dibuja(void)
{
   int x, y;
   C_3D  aux1, aux2;
   ...
   aux2.x = Dim_vtn.Xf, aux2.y = Dim_vtn.Yf, aux2.z = Dim_vtn.Zi;
   Dibuja_linea_ventana_3D(aux1, aux2, Color_Eje_X);
   Posicion_ventana_3D(aux1,x,y);
   if (Visualiza_nombre_eje) Muestra_texto_ventana(x-20,y-5," ",Nombre_eje_Y);
   ...
   aux1.x = Dim_vtn.Xf, aux1.y = Dim_vtn.Yf, aux1.z = Dim_vtn.Zi;
   aux2.x = Dim_vtn.Xf, aux2.y = Dim_vtn.Yf, aux2.z = Dim_vtn.Zf;
   Dibuja_linea_ventana_3D(aux1, aux2, Color_Eje_Z);
   aux1.x = Dim_vtn.Xi, aux1.y = Dim_vtn.Yf, aux1.z = Dim_vtn.Zi;
   aux2.x = Dim_vtn.Xi, aux2.y = Dim_vtn.Yf, aux2.z = Dim_vtn.Zf;
