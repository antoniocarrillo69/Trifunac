//////////////////////////////////////////////////////////////////////////////////////////////
// Ventana de graficación de ejes en 2D modificados                                         //
...
/////////////////////////////////////////////////////////////
// Clase Ventana Ejes 2D Modificados                       //
/////////////////////////////////////////////////////////////

void Ventana_Ejes_2DM::Inicializa(void)
{
...
// Dibuja al ventana
void Ventana_Ejes_2DM::Dibuja(void)
{
   int x, y;
   C_3D  aux1, aux2;
   char xcad[5];
   ...
   aux1.x = Dim_vtn.Xi, aux1.y = ((Dim_vtn.Yf + Dim_vtn.Yi) / 2.0), aux1.z = 0.0;
   aux2.x = Dim_vtn.Xf, aux2.y = ((Dim_vtn.Yf + Dim_vtn.Yi) / 2.0), aux2.z = 0.0;
   Dibuja_linea_ventana_2D(aux1, aux2, Color_Eje_X);
   Posicion_ventana_2D(aux1,x,y);
   if (aux1.x < 0.0) xcad[0] = '-';
    else xcad[0] = '+';
   if (Visualiza_nombre_eje) Muestra_texto_ventana(x-50,y,xcad,Nombre_eje_X);
